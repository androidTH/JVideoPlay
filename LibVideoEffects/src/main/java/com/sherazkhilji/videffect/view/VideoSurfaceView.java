package com.sherazkhilji.videffect.view;
...
public class VideoSurfaceView extends GLSurfaceView {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (System.currentTimeMillis() - downTime < CLICK_INTERVAL && Math.abs(curX - downRawX) < 50) {
    ...
    private static class VideoRender implements Renderer,
        ...
        private void setmProgram() {
            mLastProgram = createProgram(mVertexShader, effect.getShader(mSurfaceView));
            if (mLastProgram == 0) {
                return;
            }
