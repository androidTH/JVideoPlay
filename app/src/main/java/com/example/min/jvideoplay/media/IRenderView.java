...
public interface IRenderView {
    ...
    int SLIDE_STATE_NONE = 400;
    int SLIDE_STATE_RIGHT = 401;
    int SLIDE_STATE_LEFT = 402;
    int SLIDE_STATE_UP = 403;
    int SLIDE_STATE_DOWN = 404;

    int SLIDE_STATE_HORIZONRAL = 405;
    int SLIDE_STATE_VERTICAL = 406;
